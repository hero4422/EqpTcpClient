...
namespace ChatClient
{
    public partial class Form1 : Form
    {
        ...
        //public delegate void MeesageRecivedHandler(string message);
        //// 이벤트 정의
        //public event MeesageRecivedHandler MessageReceived;
        ...
        public void AddMessage(string message, MessageType messageType)
        {
            ...
            switch (messageType)
            {
                ...
                case MessageType.RecvMsg:
                    ...
                    lstRecv.Items.Add(TimeStemp + " " + message + Environment.NewLine);
